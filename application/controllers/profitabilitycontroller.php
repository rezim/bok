...
{  
   ...
   function getcostsperagreements() {
       if ($_POST['date_from'] && $_POST['date_to']) {
           echo $this->profitability->getCostsPerAgreements($_POST['date_from'], $_POST['date_to']);
       } else {
           echo "blędne parametry wejściowe";
       }
   }

    function getcostsperclients() {
        if ($_POST['date_from'] && $_POST['date_to']) {
            echo $this->profitability->getCostsPerClients($_POST['date_from'], $_POST['date_to']);
        } else {
            echo "blędne parametry wejściowe";
        }
    }
