...
{  
    ...
    function showdaneklient()
   {
       ...
       $this->profitability->populateWithPost();
       $dataReportsMiesieczne = $this->profitability->getReportsMiesieczne();
        $dataReportsRoczne = $this->profitability->getReportsRoczne();
        ...
        foreach($dataReportsMiesieczne as $key=>$item)
        {
         ...
         $iloscDni = date("t",strtotime($item['dataod']));
            ...
            $dataReports[$item['rowidclient']]['umowy'][$item['rowidumowa']]['ilosc_km'] = $item['ilosc_km'];
            $dataReports[$item['rowidclient']]['umowy'][$item['rowidumowa']]['czas_pracy'] = $item['czas_pracy'];
            $dataReports[$item['rowidclient']]['umowy'][$item['rowidumowa']]['wartosc_materialow'] = $item['wartosc_materialow'];
       }
