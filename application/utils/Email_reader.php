...
function email_pull() {
   ...
   // die();
	  ...
	  $datawiadomosc = date("Y-m-d H:i:s", $email['header']->udate);
        ...
        function _readMinolta($message,$dataWiadomosci)
        {
        ...
        function getOldHPDataDevice($dom)
        {
            $assoc=array();
               ...
               $count=0;$count2=0;
               $rozaj='';$iloscBlack='';$iloscColor='';$iloscTotal='';
               foreach ($bookElemList as $book) 
               {
                   foreach ($book->childNodes as $book2) 
                   {
        ...
        function saveDataDevice($dataDevice,$dataWiadomosci)
        {
                ...
                { 
                    ...
                    //if($readtime==null || $readtime<$item->get_date("Y-m-d H:i:s"))
                    {
                              ...
                              stan_fuser,datawiadomosci,iloscstron_kolor,iloscstron_total
                                ) values 
                    ...
                    else
                    {
                        ...
                        {
                                $dateupdate = $row->dateupdate;break;
                        }
                  ...
                  if($dataDevice['logs']!=null)          
                  {
                            ...
                            else // porównujemy dane updateu
                            {
                                ...
                                { 
                                              ...
                                              timestamp = '".str_replace('T',' ',$item['timestamp'])."'";
