<div class='divFilter'>
     ...
     <a href="#" class="buttonpokaz" onClick="pokazUmowy2('divRightCenter{$czycolorbox}','divLoader{$czycolorbox}','{$czycolorbox}');return false;">Filtruj</a>
</div>
...
<script type="text/javascript">
                       ...
                       $('#txtfilternrumowy{$czycolorbox}').keypress(function(event) {
                                                 if (event.keyCode == 13) {
                                                    pokazUmowy2('divRightCenter{$czycolorbox}','divLoader{$czycolorbox}','{$czycolorbox}');return false;
                                                 }
                                             });  
    ...
    pokazUmowy2('divRightCenter{$czycolorbox}','divLoader{$czycolorbox}','{$czycolorbox}');
</script>