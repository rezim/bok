...
<div ng-app="app" ng-controller="PaymentsCtrl as ctrl" ng-cloak>
    ...
    <div class="filters-container">
        ...
        <div class="filters-right">
            ...
            <input type="text" id='txtdataod' class='textBoxNormal' style='width:90px;min-width: 90px;'
                   ng-model="date_from" datepicker required>
            ...
            <input type="text" id='txtdatado' class='textBoxNormal' style='width:90px;min-width: 90px;'
                   ng-model="date_to" datepicker required>
        ...
        <div class="filters-middle" ng-if="ctrl.getClientInvoices().length">
            ...
            <label class="labelNormal">
                numer FV <input type="text" class='textBoxNormal' ng-model="ctrl.filters.invoiceNb">
            </label>
        </div>
