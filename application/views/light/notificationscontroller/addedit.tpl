<div id='actionbuttonclick3' class="buttonDeclin" style='text-align: left;margin-left: 0px;float:left;'
     onmousedown="wsteczNoti();return false;">
    ...
    <table class='tableform' cellpadding='0' cellspacing='0'>
        ...
        {foreach from=$filedsToEdit item=item key=key}
            {if $item.activity=='1' && $item.divek=='divNotiGlowne' }
                <tr id='tr{$key}'>
                    <td class='tdOpis' {if isset($item.ishide) && $item.ishide=='1'}style="display:none;"{/if}>
                        <span>{$item.label}</span></td>
                    <td class='tdWartosc' {if isset($item.ishide) && $item.ishide=='1'}style="display:none;"{/if}>
                        ...
                        {if $item.type=='link' && $item.readonly=='0'}
                            ...
                            <img {if isset($item.wymaganylevel) && $item.wymaganylevel!=''}wymaganylevel='{$item.wymaganylevel}'
                                 ...
                                 style='display:inline;margin-left: 5px;cursor:hand;cursor:pointer;' title='Wybierz'
        ...
        {if isset($dane) }
            ...
            <tr id='tr{$key}'>
                <td class='tdOpis' colspan="2">
                    Wymiana {if $dane[0]['serial'] != $agreementSerial}Drukarki{else}Formatera{/if}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class='tdWartosc'><input class="textBoxForm" type="text" disabled value="{$dane[0]['serial']}"/>
                </td>
            </tr>
            {if $dane[0]['serial'] != $agreementSerial}
                <tr>
                    <td class='tdOpis'><span>Serial (nowa)</span></td>
                    <td class='tdWartosc'><input class="textBoxForm" type="text" disabled value="{$agreementSerial}"/>
                    </td>
                </tr>
            {/if}
            <tr>
            ...
            <tr>
                <td colspan="2" style="text-align: right">
                    ...
                    <input type="button" class="btn btn-warning" value="historia"
                           onclick='showPrinterService("{$dane[0]['umowadane']}", "{$dane[0]['rowid_agreements']}")'>
                </td>
            </tr>
        {/if}
        </tbody>
...
{else}
    <div class='divSave' style="text-align:right;margin-right:150px;" wymaganylevel='w' wymaganyzrobiony='0'>
        ...
        <div id='actionbuttonclick' class="actionbuttonZapisz"
             onmousedown="zapiszNoti('0','{$smarty.const.SCIEZKA}/notifications/save/notemplate');return false;">
            <span>Zapisz >></span>
        </div>
