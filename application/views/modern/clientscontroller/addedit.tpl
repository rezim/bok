    ...
    <div class="row container">
        <div class="col">
            <table class='table table-sm bok-two-column-layout'>
                ...
                <tr>
                    <th>
                        Id klienta w fakturowni
                    </th>
                    <td>
                        <input class="form-control form-control-sm" id='txtClientId'
                               {if !$show_payment_options && $rowid!=0}disabled{/if}
                                {if $rowid!=0}value="{$dataClient[0].client_id|escape:'htmlall'}"{/if}
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea id="txtDodatkowyOpis" rows="3"
