...
class notification extends Model
{
    ...
    function save($czymail = '0')
    {
        ...
        if ($this->_filedsToEdit['rowid_client']['value'] == '' && $this->_filedsToEdit['email']['value'] != '') { // spróbuj przypisać rowid_clienta na podstawie email
        ...
        if ($this->_filedsToEdit['rowid_client']['value'] != '') { // spróbuj przypisać rowid_clienta na podstawie email
